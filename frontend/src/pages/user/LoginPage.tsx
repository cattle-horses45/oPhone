  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Precision crosshair decoration — top right */}
        ...
        <div className="flex-1 p-8 md:p-12 flex flex-col justify-center">
          ...
          <div className="hidden md:block mb-8">
            ...
            <p className="text-sm" style={{ color: '#8B95A5' }}>
              还没有账号？{' '}
              <Link to="/register" className="font-medium hover:underline" style={{ color: '#3D6A94' }}>
                立即注册
              </Link>
            </p>
          </div>
          ...
          {/* Test accounts */}
          <div className="mt-8 pt-6 text-center" style={{ borderTop: '1px solid rgba(15,23,42,0.06)' }}>
            <p className="text-xs tracking-wide" style={{ color: '#8B95A5', fontFamily: "'Space Mono', 'Courier New', monospace" }}>
